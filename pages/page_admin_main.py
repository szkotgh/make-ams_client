...
class PageAdminMain(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Button(self.admin_frame, text="문 열어놓기", font=(config.DEFAULT_FONT, 16, 'bold'), height=2, width=43, command=lambda: self.controller.show_page("PageAdminForceOpen")).pack()
